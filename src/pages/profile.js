      ...
      <div className="flex flex-rows justify-center gap-20 pt-10">
        <div className="flex flex-col">
          <div className="flex items-center gap-3">
            ...
            <Link href="/profile" className="hover:text-main-purple hover:font-semibold">Ubah Profil</Link>
          </div>
          ...
          <div className="flex items-center pt-4 gap-3">
            ...
            <Link href="/" className="hover:text-main-purple hover:font-semibold">Keluar</Link>
          </div>
