      ...
      <div className="flex flex-rows justify-center gap-20 pt-10">
        ...
        <div className="flex flex-col border-2 rounded-lg py-10 px-7">
          ...
          <div className="pt-3 flex flex-col w-96">
              ...
              <input className="ml-4 pl-4 border border-gray-300 rounded-md py-2 hover:border-main-purple outline-none" type="text" placeholder="John Doe" />
              <div className="pl-4 pt-2 pb-1 text-second-purple text-sm font-bold">Nomor Telepon</div>
              <input className="ml-4 pl-4 border border-gray-300 rounded-md py-2 hover:border-main-purple outline-none" type="text" placeholder="+6213486777" />
              <div className="pl-4 pt-2 pb-1 text-second-purple text-sm font-bold">Email</div>
              <input className="ml-4 pl-4 border border-gray-300 rounded-md py-2 hover:border-main-purple outline-none" type="text" placeholder="JohnDoe@gmail.com" />
