      ...
      <div className="flex justify-center">
        ...
        >
          <div className="w-full">
            <Link
              href="/"
              className="flex gap-5 items-center bg-purple-900 p-3 px-10 rounded-xl text-white hover:bg-purple-700 md:pr-80 duration-75"
            >
              {" "}
              <LuArrowLeft /> {
                airportButton.originAirport.airportCode
              } &gt; {airportButton.destinationAirport.airportCode} -{" "}
              {countPassengerButton} Penumpang - {classButton}
            </Link>
          </div>
