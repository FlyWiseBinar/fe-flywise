  ...
  return (
    <>
      <div className={`${styles.mainRow} gap-3`}>
        ...
        <div className="text-main-purple hover:text-third-purple text-4xl" onClick={openModal}>
          <AiOutlineSearch />
        </div>
        {isOpen && (
          <div className="fixed inset-0 inset- flex items-center justify-center z-50">
            <div className="absolute bg-white rounded-lg shadow-2xl w-96 h-72">
              <div className="flex gap-3 items-center p-4 "><input type="text" placeholder="  Masukkan Nomor Penerbangan" className="py-1 px-3 border-2 w-full rounded-lg border-gray-300"/> <div className="text-2xl hover:text-gray-400" onClick={closeModal}><LuX/></div></div>
