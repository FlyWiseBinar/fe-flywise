...
const Detail = () => {
    return (
        <div className=' flex flex-col bg-white rounded-xl justify-center items-center content-start p-5 mt-10'>
            ...
            <div className="w-[400px]">
                ...
                <p className="font-medium text-sm">Soekarno Hatta - Terminal 1A Domestik</p>


                <div className="flex flex-row items-center gap-3 border-t-2 border-b-2 my-3">
                    <div className="h-full items-center flex">
                        <Image src="/assets/JetAir.png" alt="JetAir" width={20} height={20} className="items-center" />
                    </div>
                ...
                <div className="border-b-2">
                    ...
                    <p className="text-sm font-medium mb-3">Melbourne International Airport</p>
                </div>
                ...
                <div className="flex justify-between items-center">
                    ...
                    <p className="font-bold text-lg text-purple-900 my-3">IDR 10.100.000</p>
                </div>
